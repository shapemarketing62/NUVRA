...
export function DemoBadge({label="Demo",style}:{label?:string;style?:CSSProperties}) { return <span className="badge badge-info" style={style}>{label}</span>; }
